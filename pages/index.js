...
function Home({ changeTheme, theme }) {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Satexpad Chainlist</title>
        ...
        <div className={ theme.palette.type === 'dark' ? classes.containerDark : classes.container }>
          <div className={ classes.copyContainer }>
            <div className={ classes.copyCentered }>
              <Typography variant='h1' className={ classes.chainListSpacing }><span className={ classes.helpingUnderline }>Satexpad Chainlist</span></Typography>
